...
namespace ultralight
{
    ...
    {
    public:
        GPUDriverD3D11(PlatformGPUContextD3D11* context);
        ...
        bool HasCommandsPending() override { return !command_list_.empty(); }
    ...
    public:
        ID3D11Texture2D* GetTexture(uint32_t texture_id) { return textures_[texture_id].first.Get(); }
    ...
    protected:
        ...
        PlatformGPUContextD3D11* context_;
