...
namespace GFXL
{
    ...
    namespace RHI
    {
        ...
        // == events ==
        HANDLE                      m_workerFinishEvents[GFXL_MAX_WORKER_THREADS];
        HANDLE                      m_workerFrameEvents[GFXL_MAX_WORKER_THREADS];


        // == worker-related stuff ==
        WorkerThreadInstance*	    m_workerThreads[GFXL_MAX_WORKER_THREADS] = {};


        // == resources ==
        IDXGISwapChain*		        m_swapChains[GFXL_MAX_WINDOWS] = {};
        RHIDirectX11_Shader*        m_shaders[GFXL_MAX_SHADERS] = {};
        RHIDirectX11_RenderBuffer*  m_renderBuffers[GFXL_MAX_RENDER_BUFFERS] = {};
        //RHIDirectX11_Texture2D*   m_textures2d[GFXL_MAX_TEXTURES2D] = {};
...
#pragma region WorkerThread impl
        ...
        public:
            ...
            void ExecuteCommand(GFXLCommandHeader::_enum header, uint32_t* position);
        ...
        void WorkerThreadInstance::ExecuteCommand(GFXLCommandHeader::_enum header, uint32_t* position)
        {
...
#pragma region RHI base implementation
        ...
        {
            uint32_t dataBegin[GFXL_MAX_WORKER_THREADS] = {};
            uint32_t commandCount[GFXL_MAX_WORKER_THREADS] = {};
