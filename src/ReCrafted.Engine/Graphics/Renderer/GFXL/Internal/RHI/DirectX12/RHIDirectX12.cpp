...
namespace GFXL
{
	namespace RHI
	{
        ...
        // == resources ==
        IDXGISwapChain3*		    m_swapChains        [GFXL_MAX_WINDOWS] = {};
        RHIDirectX12_RenderBuffer*  m_renderBuffers     [GFXL_MAX_RENDER_BUFFERS]               = {};
        RHIDirectX12_Texture2D*     m_textures2d        [GFXL_MAX_TEXTURES2D]                     = {};
