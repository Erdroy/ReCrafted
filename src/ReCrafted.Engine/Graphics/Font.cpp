...
byte* GenerateCharmap(FT_Face face, int charmap, uint charmapWidth, uint charmapHeight, Array<PreFontGlyph> glyphs,
                      Array<PreFontGlyph>& failed, Array<Font::Glyph>& outputGlyphs)
{
