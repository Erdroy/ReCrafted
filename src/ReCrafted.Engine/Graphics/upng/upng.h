...
{
public:
	static upng_t* upng_new_from_bytes(const unsigned char* buffer, unsigned long size);
	static upng_t* upng_new_from_file(const char* path);
	static void upng_free(upng_t* upng);

	static upng_error upng_header(upng_t* upng);
	static upng_error upng_decode(upng_t* upng);

	static upng_error upng_get_error(const upng_t* upng);
	static unsigned	upng_get_error_line(const upng_t* upng);

	static unsigned	upng_get_width(const upng_t* upng);
	static unsigned	upng_get_height(const upng_t* upng);
	...
	static unsigned	upng_get_pixelsize(const upng_t* upng);
	static upng_format	upng_get_format(const upng_t* upng);

	static const unsigned char*	upng_get_buffer(const upng_t* upng);
	static unsigned	upng_get_size(const upng_t* upng);
};
