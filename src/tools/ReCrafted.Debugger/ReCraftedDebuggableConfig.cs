...
{
    internal class ReCraftedDebuggableConfig : IVsDebuggableProjectCfg, IVsProjectFlavorCfg
    {
        private IVsProjectFlavorCfg _baseProjectCfg;
        private readonly Project _baseProject;

        public ReCraftedDebuggableConfig(IVsProjectFlavorCfg pBaseProjectCfg, EnvDTE.Project project)
        {
        ...
        public int DebugLaunch(uint grfLaunch)
        {
            ...
            var startInfo = new ReCraftedStartInfo(startArgs, null, _baseProject);
            var session = new ReCraftedDebuggerSession();
            ...
            {
                throw new Exception("Exception! error: " + ex);
            }
            return VSConstants.S_OK;
        }
