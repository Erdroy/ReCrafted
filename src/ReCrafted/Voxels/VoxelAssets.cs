...
namespace ReCrafted.Voxels
{
    ...
    public static class VoxelAssets
    {
        ...
        internal static void LoadAssets()
        {
            ...
            {
                Name = "stone",
                Texture = Texture2D.FromFile("assets/textures/blocks/stone.png", Sampler.Type.PointClamped, true)
            });

            AddBlock(2, new VoxelBlock
            {
                Name = "dirt",
                Texture = Texture2D.FromFile("assets/textures/blocks/dirt.png", Sampler.Type.PointClamped, true)
            });
            ...
            {
                Name = "sand",
                Texture = Texture2D.FromFile("assets/textures/blocks/sand.png", Sampler.Type.PointClamped, true)
            });

            AddBlock(5, new VoxelBlock
            {
                Name = "bedrock",
                Texture = Texture2D.FromFile("assets/textures/blocks/bedrock.png", Sampler.Type.PointClamped, true)
            });

            AddBlock(6, new VoxelBlock
            {
                Name = "planks",
                Texture = Texture2D.FromFile("assets/textures/blocks/planks.png", Sampler.Type.PointClamped, true)
            });

            AddBlock(20, new VoxelBlock
            {
                Name = "coal ore",
                Texture = Texture2D.FromFile("assets/textures/blocks/coal_ore.png", Sampler.Type.PointClamped, true)
            });

            AddBlock(21, new VoxelBlock
            {
                Name = "iron ore",
                Texture = Texture2D.FromFile("assets/textures/blocks/iron_ore.png", Sampler.Type.PointClamped, true)
            });

            AddBlock(22, new VoxelBlock
            {
                Name = "gold ore",
                Texture = Texture2D.FromFile("assets/textures/blocks/gold_ore.png", Sampler.Type.PointClamped, true)
            });
        }
