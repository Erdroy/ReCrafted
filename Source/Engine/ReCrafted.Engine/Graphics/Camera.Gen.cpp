...
void Camera::InitRuntime() 
{
    ...
    API_BIND("ReCrafted.API.Graphics.Camera::InternalSetAsCurrent", &APIProxy::Camera_SetAsCurrent1);
    API_BIND("ReCrafted.API.Graphics.Camera::InternalSetLookAt", &APIProxy::Camera_SetLookAt2);
    API_BIND("ReCrafted.API.Graphics.Camera::InternalCreate", &APIProxy::Camera_Create3);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalBoundingFrustum", &APIProxy::Camera_Get_BoundingFrustum1);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalProjection", &APIProxy::Camera_Get_Projection2);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalView", &APIProxy::Camera_Get_View3);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalViewProjection", &APIProxy::Camera_Get_ViewProjection4);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalPosition", &APIProxy::Camera_Get_Position5);
    API_BIND("ReCrafted.API.Graphics.Camera::Set_InternalPosition", &APIProxy::Camera_Set_Position5);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalRotation", &APIProxy::Camera_Get_Rotation6);
    API_BIND("ReCrafted.API.Graphics.Camera::Set_InternalRotation", &APIProxy::Camera_Set_Rotation6);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalFov", &APIProxy::Camera_Get_Fov7);
    API_BIND("ReCrafted.API.Graphics.Camera::Set_InternalFov", &APIProxy::Camera_Set_Fov7);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalNearPlane", &APIProxy::Camera_Get_NearPlane8);
    API_BIND("ReCrafted.API.Graphics.Camera::Set_InternalNearPlane", &APIProxy::Camera_Set_NearPlane8);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalFarPlane", &APIProxy::Camera_Get_FarPlane9);
    API_BIND("ReCrafted.API.Graphics.Camera::Set_InternalFarPlane", &APIProxy::Camera_Set_FarPlane9);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalForward", &APIProxy::Camera_Get_Forward10);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalRight", &APIProxy::Camera_Get_Right11);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalUp", &APIProxy::Camera_Get_Up12);
    API_BIND("ReCrafted.API.Graphics.Camera::Get_InternalMainCamera", &APIProxy::Camera_Get_MainCamera13);
}

const char* Camera::Fullname() 
{
    return "ReCrafted.API.Graphics.Camera";
}
