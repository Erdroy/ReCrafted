...
/**
 * \brief The RegularCellData structure holds information about the triangulation
 *  used for a single equivalence class in the modified Marching Cubes algorithm,
 *  described in Section 3.2.
 */
struct RegularCellData_t
{
    /**
     * \brief High nibble is vertex count, low nibble is triangle count.
     */
    unsigned char geometryCounts;

    /**
     * \brief Groups of 3 indexes giving the triangulation.
     */
...
/**
* \brief The TransitionCellData structure holds information about the triangulation
* used for a single equivalence class in the Transvoxel Algorithm transition cell,
* described in Section 4.3.
*/
struct TransitionCellData_t
{
    /**
     * \brief High nibble is vertex count, low nibble is triangle count.
     */
...
/**
 * \brief The regularCellClass table maps an 8-bit regular Marching Cubes case index to 
...
/**
 * \brief The regularCellData table holds the triangulation data for all 16 distinct classes to
 * which a case can be mapped by the regularCellClass table.
 */
const RegularCellData_t RegularCellData[16] =
{
    { 0x00,{} },
    { 0x31,{ 0, 1, 2 } },
    { 0x62,{ 0, 1, 2, 3, 4, 5 } },
...
/**
 * \brief The regularVertexData table gives the vertex locations for every one of the 256 possible
...
/**
 * \brief The transitionCellData table holds the triangulation data for all 56 distinct classes to
 ...
 */
const TransitionCellData_t TransitionCellData[56] =
{
    { 0x00,{} },
    { 0x42,{ 0, 1, 3, 1, 2, 3 } },
    { 0x31,{ 0, 1, 2 } },
...
/**
 * \brief The transitionCornerData table contains the transition cell corner reuse data 
...
/**
 * \brief The transitionVertexData table gives the vertex locations for every one of the 512 possible
