...
#include <AppCore/shaders/hlsl/fill_fxc.h>
#include <AppCore/shaders/hlsl/fill_path_fxc.h>
#include <AppCore/shaders/hlsl/v2f_c4f_t2f_fxc.h>
#include <AppCore/shaders/hlsl/v2f_c4f_t2f_t2f_d28f_fxc.h>
...
namespace ultralight {
    ...
    void GPUDriverD3D11::CreateTexture(uint32_t texture_id,
        ...
        if (bitmap->IsEmpty()) {
            ...
            auto addr = texture_entry.first.GetAddressOf();
