...
void Texture::InitRuntime() 
{
    ...
    MONO_REGISTER_OBJECT_TYPE(Texture);
    API_BIND("ReCrafted.API.Rendering.Texture::InternalInitializeFromFile", &APIProxy::Texture_InitializeFromFile1);
    API_BIND("ReCrafted.API.Rendering.Texture::InternalGetPixel", &APIProxy::Texture_GetPixel2);
    API_BIND("ReCrafted.API.Rendering.Texture::InternalSetPixel", &APIProxy::Texture_SetPixel3);
    API_BIND("ReCrafted.API.Rendering.Texture::InternalSetPixel", &APIProxy::Texture_SetPixel4);
    API_BIND("ReCrafted.API.Rendering.Texture::InternalResize", &APIProxy::Texture_Resize5);
    API_BIND("ReCrafted.API.Rendering.Texture::Get_InternalWidth", &APIProxy::Texture_Get_Width1);
    API_BIND("ReCrafted.API.Rendering.Texture::Get_InternalHeight", &APIProxy::Texture_Get_Height2);
    API_BIND("ReCrafted.API.Rendering.Texture::Get_InternalIs3D", &APIProxy::Texture_Get_Is3D3);
}

const char* Texture::Fullname() 
{
    return "ReCrafted.API.Rendering.Texture";
}
