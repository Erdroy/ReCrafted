...
namespace Renderer
{
    ...
    /// <param name="pitch">
    /// The row pitch of texture memory, when 0,
    /// this value will be calculated and may be invalid for some formats.
    /// </param>
    ...
    RENDERER_FUNCTION(Texture2DHandle) CreateTexture2D(uint16_t width, uint16_t height, uint16_t pitch, uint8_t mipLevels,
